...
pub fn derive_reloc(input: TokenStream) -> TokenStream {
    ...
    let mut generics = add_reloc_bounds(input_args.generics.clone());
    ...
    let field_types = collect_field_types(&input_args.data, &input_args.generics);
    ...
    let expanded = quote! {
        unsafe impl #impl_generics iceoryx2::prelude::ZeroCopySend for #ident_name #type_generics #where_clause {}
        unsafe impl #impl_generics com_api::prelude::Reloc for #ident_name #type_generics #where_clause {}
    };
